...
func main(){
	...
	target := "C:\\Windows\\System32\\cmd.exe "+ cmdArgs
...
*/
	err = windows.CreateProcessAsUser(
		hTokenDup, //token Token,
		nil,  //appName *uint16,
		commandLine,  //commandLine *uint16,
		nil,  //procSecurity *SecurityAttributes,
		nil,  //threadSecurity *SecurityAttributes, //inheritHandles bool,
		true,
		0x00080000|0x00000010,  //creationFlags uint32,
		nil, //env *uint16,
		nil,   //currentDir *uint16,
		&startupInfo.StartupInfo, //startupInfo *StartupInfo,
		&procInfo) //outProcInfo *ProcessInformation
